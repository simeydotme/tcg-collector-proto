...
<section class="px-3">
  ...
  <!-- 
      🟡 special grid-mode when in zen-mode. This is auto-fill grid and mobile-first
  ...
  <section
    ...
    class={zenMode.active
      ? "mx-auto grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(380px,480px))] justify-center"
      : ""}
  >
    {#each cards as card}
      <Card {card} {set} />
